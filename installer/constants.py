...
UNINSTALL_REG_KEY = r"Software\Microsoft\Windows\CurrentVersion\Uninstall\Calendifier"
...
class InstallerIdentity:
    ...
    uninstall_key_name: str = "Calendifier"
    ...
    installer_exe_name: str = "CalendifierSetup.exe"

    # Start menu folder name under the per-user Programs directory.
    start_menu_folder: str = "Calendifier"
    shortcut_name: str = "Calendifier"
